...
from classes.modules.params.UrlsCombineModuleParams import UrlsCombineModuleParams


class UrlsCombine(UrlsModules):
    """ Class of module for DAFS by Dict+Mask """
    model = None
    mode = 'dict'
    log_path = '/dev/null'
    time_count = True
    options = UrlsCombineModuleParams().get_options()
