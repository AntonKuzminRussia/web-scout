...
from classes.modules.HostsModules import HostsModules
from classes.generators.CombineGenerator import CombineGenerator
from classes.modules.params.HostsCombineModuleParams import HostsCombineModuleParams


class HostsCombine(HostsModules):
    """ Class of module for HostsBrute by Dict+Mask """
    model = None
    mode = 'dict'
    log_path = '/dev/null'
    time_count = True
    options = HostsCombineModuleParams().get_options()
