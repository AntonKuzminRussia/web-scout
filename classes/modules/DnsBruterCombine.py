...
from classes.modules.params.DnsBruterCombineModuleParams import DnsBruterCombineModuleParams


class DnsBruterCombine(DnsBruterModules):
    """ Class of WS Module for DNS Brute by dict+mask """
    model = None
    mode = 'dict'
    log_path = '/dev/null'
    time_count = True
    options = DnsBruterCombineModuleParams().get_options()
