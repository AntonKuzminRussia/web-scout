...
class Test_SpiderLinksParser(object):
    """Unit tests for SpiderLinksParser"""
    def setup(self):
        Registry().set('config', {'spider': {'tags': 'a|href,script|src,img|src,iframe|src,frame|src,link|href', 'denied_schemes': 'mailto, javascript'}})
